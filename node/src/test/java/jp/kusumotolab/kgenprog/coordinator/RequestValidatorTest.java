...
public class RequestValidatorTest {
  ...
  public void testValidate() {
    ...
    final ExecuteTestRequest executeTestRequest1 = new ExecuteTestRequest(null, null, "localhost", 8080);
    final ExecuteTestRequest executeTestRequest2 = new ExecuteTestRequest(null, null, "localhost", 8080);
    final ExecuteTestRequest executeTestRequest3 = new ExecuteTestRequest(null, null, "localhost", 8080);
